...
## script by reviewing/running testCacheMatrix.R script in this same repository.
## (i.e., https://github.com/reggiemack-310/ProgrammingAssignment2)
##
## makeCacheMatrix:
##     
...
##         its inverse, cache it and return the new inverse.
##     
